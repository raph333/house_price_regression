...
\begin{frame}{Problemstellung II}
        ...
        \begin{itemize}
            \item Wenn die Predictoren hohe Korrelation aufweisen
            \item Bei vielen Prediktoren. Wenn #Prediktoren nahe bei Anzahl der Beobachtungen geht die Varianz gegen unendlich.
        \end{itemize}
